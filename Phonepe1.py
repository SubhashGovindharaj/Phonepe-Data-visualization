...
#     local_directory = "/Users/subhisapple/Downloads/practice"
...
def Aggregated_transaction():
    ...
    path = r"/Users/subhisapple/Downloads/practice/data/aggregated/transaction/country/india/state"
    at = os.listdir(path)
    for state in at:
...
def Aggregated_users():
    ...
    path = r"/Users/subhisapple/Downloads/practice/data/aggregated/user/country/india/state"
    at = os.listdir(path)
    for state in at:
      states = os.listdir(path +'/'+state)
      for year in states:
...
def map_transaction():
    ...
    path = r"/Users/subhisapple/Downloads/practice/data/map/transaction/hover/country/india/state"
    at = os.listdir(path)
    for state in at:
      states = os.listdir(path +'/'+state)
      for year in states:
...
def map_users():
    ...
    path = r"/Users/subhisapple/Downloads/practice/data/map/user/hover/country/india/state"
    at = os.listdir(path)
    for state in at:
      states = os.listdir(path +'/'+state)
      for year in states:
...
def top_transaction():
    ...
    path = r"/Users/subhisapple/Downloads/practice/data/top/transaction/country/india/state"
    at = os.listdir(path)
    for state in at:
      states = os.listdir(path +'/'+state)
      for year in states:
...
def top_users():
    ...
    path = r"/Users/subhisapple/Downloads/practice/data/top/user/country/india/state"
    at = os.listdir(path)
    for state in at:
      states = os.listdir(path +'/'+state)
      for year in states:
...
def to_sql():
    db = psycopg2.connect(host='localhost', user='postgres', password='subhash', port=5433, database='Phonepe')
    exe = db.cursor()
